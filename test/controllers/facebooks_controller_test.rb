...
class FacebooksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create facebook" do
    assert_difference('Facebook.count') do
      post facebooks_url, params: { facebook: { email: @facebook.email, password: @facebook.password } }
    end
  ...
  test "should update facebook" do
    patch facebook_url(@facebook), params: { facebook: { email: @facebook.email, password: @facebook.password } }
